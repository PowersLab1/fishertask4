...
function startExperiment() {
    ...
    const mainTrials = [mainTrials4, mainTrials8, mainTrials1, mainTrials9, mainTrials7, mainTrials10, mainTrials3, mainTrials6, mainTrials2, mainTrials5];
    ...
    // shuffleArray(blockOrder); // REMOVE RANDOMIZATION
    ...
    function endExperiment() {
        ...
        sessionStorage.setItem('fishertask4taskData', trialsDataJson);
        window.postMessage({
            type: 'fishertask4labjs.data',
            json: trialsDataJson
        }, '*');
    }
